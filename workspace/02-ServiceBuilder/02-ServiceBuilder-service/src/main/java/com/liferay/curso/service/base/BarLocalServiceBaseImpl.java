...
import com.liferay.curso.service.BarLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.curso.service.impl.BarLocalServiceImpl}.
 * </p>
 *
...
public abstract class BarLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.curso.service.BarLocalServiceUtil} to access the bar local service.
	 */
	...
	public void addFooBar(long fooId, long barId) {
		fooPersistence.addBar(fooId, barId);
	}
	...
	public void addFooBar(long fooId, Bar bar) {
		fooPersistence.addBar(fooId, bar);
	}
	...
	public void addFooBars(long fooId, long[] barIds) {
		fooPersistence.addBars(fooId, barIds);
	}
	...
	public void addFooBars(long fooId, List<Bar> bars) {
		fooPersistence.addBars(fooId, bars);
	}
	...
	public void clearFooBars(long fooId) {
		fooPersistence.clearBars(fooId);
	}
	...
	public void deleteFooBar(long fooId, long barId) {
		fooPersistence.removeBar(fooId, barId);
	}
	...
	public void deleteFooBar(long fooId, Bar bar) {
		fooPersistence.removeBar(fooId, bar);
	}
	...
	public void deleteFooBars(long fooId, long[] barIds) {
		fooPersistence.removeBars(fooId, barIds);
	}
	...
	public void deleteFooBars(long fooId, List<Bar> bars) {
		fooPersistence.removeBars(fooId, bars);
	}
	...
	public long[] getFooPrimaryKeys(long barId) {
		return barPersistence.getFooPrimaryKeys(barId);
	}
	...
	public List<Bar> getFooBars(long fooId) {
		return fooPersistence.getBars(fooId);
	}
	...
	public List<Bar> getFooBars(long fooId, int start, int end) {
		return fooPersistence.getBars(fooId, start, end);
	}
	...
	public List<Bar> getFooBars(long fooId, int start, int end,
		...
		return fooPersistence.getBars(fooId, start, end, orderByComparator);
	}
	...
	public int getFooBarsCount(long fooId) {
		return fooPersistence.getBarsSize(fooId);
	}
	...
	public boolean hasFooBar(long fooId, long barId) {
		return fooPersistence.containsBar(fooId, barId);
	}
	...
	public boolean hasFooBars(long fooId) {
		return fooPersistence.containsBars(fooId);
	}
	...
	public void setFooBars(long fooId, long[] barIds) {
		fooPersistence.setBars(fooId, barIds);
	}
	 ...
	 */
	public com.liferay.curso.service.FooLocalService getFooLocalService() {
	...
	public void setFooLocalService(
		com.liferay.curso.service.FooLocalService fooLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.curso.model.Bar",
			barLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.curso.model.Bar");
	}
	...
	@BeanReference(type = com.liferay.curso.service.FooLocalService.class)
	protected com.liferay.curso.service.FooLocalService fooLocalService;
