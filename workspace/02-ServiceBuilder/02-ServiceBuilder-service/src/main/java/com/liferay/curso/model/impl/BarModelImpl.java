...
import com.liferay.curso.model.BarModel;
import com.liferay.curso.model.BarSoap;
...
/**
 * The base model implementation for the Bar service. Represents a row in the &quot;FOO_Bar&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BarModelImpl extends BaseModelImpl<Bar> implements BarModel {
	 ...
	 */
	public static final String TABLE_NAME = "FOO_Bar";
	...
	public static final String TABLE_SQL_CREATE = "create table FOO_Bar (uuid_ VARCHAR(75) null,barId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table FOO_Bar";
	public static final String ORDER_BY_JPQL = " ORDER BY bar.field1 ASC";
	public static final String ORDER_BY_SQL = " ORDER BY FOO_Bar.field1 ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.curso.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.curso.model.Bar"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.curso.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.curso.model.Bar"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.curso.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.curso.model.Bar"),
			true);
	...
	public static final String MAPPING_TABLE_FOO_FOO_BAR_NAME = "FOO_Foo_Bar";
	public static final Object[][] MAPPING_TABLE_FOO_FOO_BAR_COLUMNS = {
			{ "companyId", Types.BIGINT },
			{ "barId", Types.BIGINT },
			{ "fooId", Types.BIGINT }
		};
	public static final String MAPPING_TABLE_FOO_FOO_BAR_SQL_CREATE = "create table FOO_Foo_Bar (companyId LONG not null,barId LONG not null,fooId LONG not null,primary key (barId, fooId))";
	public static final boolean FINDER_CACHE_ENABLED_FOO_FOO_BAR = GetterUtil.getBoolean(com.liferay.curso.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.FOO_Foo_Bar"), true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.curso.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.curso.model.Bar"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.curso.model.Bar");
