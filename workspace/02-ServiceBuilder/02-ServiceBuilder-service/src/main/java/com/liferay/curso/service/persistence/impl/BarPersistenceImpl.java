...
import com.liferay.curso.model.impl.BarImpl;
import com.liferay.curso.model.impl.BarModelImpl;
 ...
 * @see BarPersistence
 * @see com.liferay.curso.service.persistence.BarUtil
 * @generated
 */
@ProviderType
public class BarPersistenceImpl extends BasePersistenceImpl<Bar>
	 ...
	 */
	@Override
	public List<com.liferay.curso.model.Foo> getFoos(long pk) {
	 ...
	 */
	@Override
	public List<com.liferay.curso.model.Foo> getFoos(long pk, int start, int end) {
	 ...
	 */
	@Override
	public List<com.liferay.curso.model.Foo> getFoos(long pk, int start,
		int end,
	...
	public void addFoo(long pk, long fooPK) {
		Bar bar = fetchByPrimaryKey(pk);

		if (bar == null) {
			barToFooTableMapper.addTableMapping(companyProvider.getCompanyId(),
				pk, fooPK);
		}
		else {
			barToFooTableMapper.addTableMapping(bar.getCompanyId(), pk, fooPK);
		}
	}
	...
	public void addFoos(long pk, long[] fooPKs) {
		...
		barToFooTableMapper.addTableMappings(companyId, pk, fooPKs);
	}
	 ...
	 */
	@Override
	public void addFoos(long pk, List<com.liferay.curso.model.Foo> foos) {
		addFoos(pk,
			ListUtil.toLongArray(foos,
				com.liferay.curso.model.Foo.FOO_ID_ACCESSOR));
	}
	...
	public void removeFoos(long pk, long[] fooPKs) {
		barToFooTableMapper.deleteTableMappings(pk, fooPKs);
	}
	 ...
	 */
	@Override
	public void removeFoos(long pk, List<com.liferay.curso.model.Foo> foos) {
		removeFoos(pk,
			ListUtil.toLongArray(foos,
				com.liferay.curso.model.Foo.FOO_ID_ACCESSOR));
	}
	...
	public void setFoos(long pk, long[] fooPKs) {
		...
		barToFooTableMapper.deleteTableMappings(pk,
			ArrayUtil.toLongArray(removeFooPKsSet));
		...
		barToFooTableMapper.addTableMappings(companyId, pk,
			ArrayUtil.toLongArray(newFooPKsSet));
	}
	 ...
	 */
	@Override
	public void setFoos(long pk, List<com.liferay.curso.model.Foo> foos) {
		try {
			long[] fooPKs = new long[foos.size()];

			for (int i = 0; i < foos.size(); i++) {
				com.liferay.curso.model.Foo foo = foos.get(i);
	...
	public void afterPropertiesSet() {
		barToFooTableMapper = TableMapperFactory.getTableMapper("FOO_Foo_Bar",
				"companyId", "barId", "fooId", this, fooPersistence);
	}
	...
	protected TableMapper<Bar, com.liferay.curso.model.Foo> barToFooTableMapper;
