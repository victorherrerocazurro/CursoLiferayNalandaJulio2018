...
package com.liferay.curso.service.base;
...
import com.liferay.curso.service.FooLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.curso.service.impl.FooLocalServiceImpl}.
 * </p>
 *
...
public abstract class FooLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.curso.service.FooLocalServiceUtil} to access the foo local service.
	 */
	...
	public void addBarFoo(long barId, long fooId) {
		barPersistence.addFoo(barId, fooId);
	}
	...
	public void addBarFoos(long barId, long[] fooIds) {
		barPersistence.addFoos(barId, fooIds);
	}
	...
	public void addBarFoos(long barId, List<Foo> foos) {
		barPersistence.addFoos(barId, foos);
	}
	...
	public void clearBarFoos(long barId) {
		barPersistence.clearFoos(barId);
	}
	...
	public void deleteBarFoo(long barId, long fooId) {
		barPersistence.removeFoo(barId, fooId);
	}
	...
	public void deleteBarFoos(long barId, long[] fooIds) {
		barPersistence.removeFoos(barId, fooIds);
	}
	...
	public void deleteBarFoos(long barId, List<Foo> foos) {
		barPersistence.removeFoos(barId, foos);
	}
	...
	public long[] getBarPrimaryKeys(long fooId) {
		return fooPersistence.getBarPrimaryKeys(fooId);
	}
	...
	public List<Foo> getBarFoos(long barId) {
		return barPersistence.getFoos(barId);
	}
	...
	public List<Foo> getBarFoos(long barId, int start, int end) {
		return barPersistence.getFoos(barId, start, end);
	}
	...
	public List<Foo> getBarFoos(long barId, int start, int end,
		...
		return barPersistence.getFoos(barId, start, end, orderByComparator);
	}
	...
	public int getBarFoosCount(long barId) {
		return barPersistence.getFoosSize(barId);
	}
	...
	public boolean hasBarFoo(long barId, long fooId) {
		return barPersistence.containsFoo(barId, fooId);
	}
	...
	public boolean hasBarFoos(long barId) {
		return barPersistence.containsFoos(barId);
	}
	...
	public void setBarFoos(long barId, long[] fooIds) {
		barPersistence.setFoos(barId, fooIds);
	}
	 ...
	 */
	public com.liferay.curso.service.BarLocalService getBarLocalService() {
	...
	public void setBarLocalService(
		com.liferay.curso.service.BarLocalService barLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.curso.model.Foo",
			fooLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.curso.model.Foo");
	}
	...
	@BeanReference(type = com.liferay.curso.service.BarLocalService.class)
	protected com.liferay.curso.service.BarLocalService barLocalService;
