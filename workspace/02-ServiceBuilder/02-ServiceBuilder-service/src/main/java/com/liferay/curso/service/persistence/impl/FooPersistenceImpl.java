...
import com.liferay.curso.exception.NoSuchFooException;
import com.liferay.curso.model.Foo;
import com.liferay.curso.model.impl.FooImpl;
import com.liferay.curso.model.impl.FooModelImpl;
import com.liferay.curso.service.persistence.BarPersistence;
 ...
 * @see FooPersistence
 * @see com.liferay.curso.service.persistence.FooUtil
 * @generated
 */
@ProviderType
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	protected Foo removeImpl(Foo foo) {
		...
		fooToBarTableMapper.deleteLeftPrimaryKeyTableMappings(foo.getPrimaryKey());
	...
	/**
	 * Returns the primaryKeys of bars associated with the foo.
	 *
	 * @param pk the primary key of the foo
	 * @return long[] of the primaryKeys of bars associated with the foo
	 */
	@Override
	public long[] getBarPrimaryKeys(long pk) {
		long[] pks = fooToBarTableMapper.getRightPrimaryKeys(pk);

		return pks.clone();
	}

	/**
	 * Returns all the bars associated with the foo.
	 *
	 * @param pk the primary key of the foo
	 * @return the bars associated with the foo
	 */
	@Override
	public List<com.liferay.curso.model.Bar> getBars(long pk) {
		return getBars(pk, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	}

	/**
	 * Returns a range of all the bars associated with the foo.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FooModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param start the lower bound of the range of foos
	 * @param end the upper bound of the range of foos (not inclusive)
	 * @return the range of bars associated with the foo
	 */
	@Override
	public List<com.liferay.curso.model.Bar> getBars(long pk, int start, int end) {
		return getBars(pk, start, end, null);
	}

	/**
	 * Returns an ordered range of all the bars associated with the foo.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FooModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param end the upper bound of the range of foos (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of bars associated with the foo
	 */
	@Override
	public List<com.liferay.curso.model.Bar> getBars(long pk, int start,
		int end,
		OrderByComparator<com.liferay.curso.model.Bar> orderByComparator) {
		return fooToBarTableMapper.getRightBaseModels(pk, start, end,
			orderByComparator);
	}

	/**
	 * Returns the number of bars associated with the foo.
	 *
	 * @param pk the primary key of the foo
	 * @return the number of bars associated with the foo
	 */
	@Override
	public int getBarsSize(long pk) {
		long[] pks = fooToBarTableMapper.getRightPrimaryKeys(pk);
	...
	/**
	 * Returns <code>true</code> if the bar is associated with the foo.
	 *
	 * @param pk the primary key of the foo
	 * @param barPK the primary key of the bar
	 * @return <code>true</code> if the bar is associated with the foo; <code>false</code> otherwise
	 */
	@Override
	public boolean containsBar(long pk, long barPK) {
		return fooToBarTableMapper.containsTableMapping(pk, barPK);
	}

	/**
	 * Returns <code>true</code> if the foo has any bars associated with it.
	 *
	 * @param pk the primary key of the foo to check for associations with bars
	 * @return <code>true</code> if the foo has any bars associated with it; <code>false</code> otherwise
	 */
	@Override
	public boolean containsBars(long pk) {
		if (getBarsSize(pk) > 0) {
			return true;
		}
		else {
	...
	/**
	 * Adds an association between the foo and the bar. Also notifies the appropriate model listeners and clears the mapping table finder cache.
	 *
	 * @param pk the primary key of the foo
	 * @param barPK the primary key of the bar
	 */
	@Override
	public void addBar(long pk, long barPK) {
		Foo foo = fetchByPrimaryKey(pk);

		if (foo == null) {
			fooToBarTableMapper.addTableMapping(companyProvider.getCompanyId(),
				pk, barPK);
		}
		else {
			fooToBarTableMapper.addTableMapping(foo.getCompanyId(), pk, barPK);
		}
	}
	 ...
	 */
	@Override
	public void addBar(long pk, com.liferay.curso.model.Bar bar) {
		Foo foo = fetchByPrimaryKey(pk);

		if (foo == null) {
			fooToBarTableMapper.addTableMapping(companyProvider.getCompanyId(),
				pk, bar.getPrimaryKey());
		}
		else {
			fooToBarTableMapper.addTableMapping(foo.getCompanyId(), pk,
				bar.getPrimaryKey());
		}
	}

	/**
	 * Adds an association between the foo and the bars. Also notifies the appropriate model listeners and clears the mapping table finder cache.
	 *
	 * @param pk the primary key of the foo
	 * @param barPKs the primary keys of the bars
	 */
	@Override
	public void addBars(long pk, long[] barPKs) {
		long companyId = 0;
		...
		fooToBarTableMapper.addTableMappings(companyId, pk, barPKs);
	}
	 ...
	 */
	@Override
	public void addBars(long pk, List<com.liferay.curso.model.Bar> bars) {
		addBars(pk,
			ListUtil.toLongArray(bars,
				com.liferay.curso.model.Bar.BAR_ID_ACCESSOR));
	}

	/**
	 * Clears all associations between the foo and its bars. Also notifies the appropriate model listeners and clears the mapping table finder cache.
	 *
	 * @param pk the primary key of the foo to clear the associated bars from
	 */
	@Override
	public void clearBars(long pk) {
		fooToBarTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}

	/**
	 * Removes the association between the foo and the bar. Also notifies the appropriate model listeners and clears the mapping table finder cache.
	 *
	 * @param pk the primary key of the foo
	 * @param barPK the primary key of the bar
	 */
	@Override
	public void removeBar(long pk, long barPK) {
		fooToBarTableMapper.deleteTableMapping(pk, barPK);
	}
	 ...
	 */
	@Override
	public void removeBar(long pk, com.liferay.curso.model.Bar bar) {
		fooToBarTableMapper.deleteTableMapping(pk, bar.getPrimaryKey());
	}

	/**
	 * Removes the association between the foo and the bars. Also notifies the appropriate model listeners and clears the mapping table finder cache.
	 *
	 * @param pk the primary key of the foo
	 * @param barPKs the primary keys of the bars
	 */
	@Override
	public void removeBars(long pk, long[] barPKs) {
		fooToBarTableMapper.deleteTableMappings(pk, barPKs);
	}
	 ...
	 */
	@Override
	public void removeBars(long pk, List<com.liferay.curso.model.Bar> bars) {
		removeBars(pk,
			ListUtil.toLongArray(bars,
				com.liferay.curso.model.Bar.BAR_ID_ACCESSOR));
	}
	...
	/**
	 * Sets the bars associated with the foo, removing and adding associations as necessary. Also notifies the appropriate model listeners and clears the mapping table finder cache.
	 *
	 * @param pk the primary key of the foo
	 * @param barPKs the primary keys of the bars to be associated with the foo
	 */
	@Override
	public void setBars(long pk, long[] barPKs) {
		Set<Long> newBarPKsSet = SetUtil.fromArray(barPKs);
		Set<Long> oldBarPKsSet = SetUtil.fromArray(fooToBarTableMapper.getRightPrimaryKeys(
					pk));

		Set<Long> removeBarPKsSet = new HashSet<Long>(oldBarPKsSet);

		removeBarPKsSet.removeAll(newBarPKsSet);

		fooToBarTableMapper.deleteTableMappings(pk,
			ArrayUtil.toLongArray(removeBarPKsSet));

		newBarPKsSet.removeAll(oldBarPKsSet);
		...
		fooToBarTableMapper.addTableMappings(companyId, pk,
			ArrayUtil.toLongArray(newBarPKsSet));
	}
	 ...
	 *
	 * @param pk the primary key of the foo
	 * @param bars the bars to be associated with the foo
	 */
	@Override
	public void setBars(long pk, List<com.liferay.curso.model.Bar> bars) {
		try {
			long[] barPKs = new long[bars.size()];

			for (int i = 0; i < bars.size(); i++) {
				com.liferay.curso.model.Bar bar = bars.get(i);

				barPKs[i] = bar.getPrimaryKey();
			}
	...
	public void afterPropertiesSet() {
		fooToBarTableMapper = TableMapperFactory.getTableMapper("FOO_Foo_Bar",
				"companyId", "fooId", "barId", this, barPersistence);
	}
	...
	public void destroy() {
		...
		TableMapperFactory.removeTableMapper("FOO_Foo_Bar");
	}
	...
	protected TableMapper<Foo, com.liferay.curso.model.Bar> fooToBarTableMapper;
