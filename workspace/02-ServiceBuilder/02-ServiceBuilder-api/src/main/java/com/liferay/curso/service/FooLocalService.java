...
public interface FooLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FooLocalServiceUtil} to access the foo local service. Add custom service methods to {@link com.liferay.curso.service.impl.FooLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public void addBarFoo(long barId, Foo foo);

	public void addBarFoo(long barId, long fooId);

	public void addBarFoos(long barId, List<Foo> foos);
	...
	*/
	...
	public List<Foo> buscarFoosPorField1(java.lang.String field1, int begin,
		int end);
	...
	*/
	...
	public void deleteBarFoo(long barId, Foo foo);

	public void deleteBarFoo(long barId, long fooId);

	public void deleteBarFoos(long barId, List<Foo> foos);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Foo> getBarFoos(long barId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Foo> getBarFoos(long barId, int start, int end);
