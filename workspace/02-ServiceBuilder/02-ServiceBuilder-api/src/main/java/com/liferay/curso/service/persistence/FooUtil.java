 ...
 * @see FooPersistence
 * @see com.liferay.curso.service.persistence.impl.FooPersistenceImpl
 * @generated
 */
@ProviderType
public class FooUtil {
	...
	*/
	public static Foo findByUuid_First(java.lang.String uuid,
		...
		throws com.liferay.curso.exception.NoSuchFooException {
	...
	*/
	public static long[] getBarPrimaryKeys(long pk) {
		return getPersistence().getBarPrimaryKeys(pk);
	}
	...
	*/
	public static List<com.liferay.curso.model.Bar> getBars(long pk) {
		return getPersistence().getBars(pk);
	}
	...
	*/
	public static List<com.liferay.curso.model.Bar> getBars(long pk, int start,
		int end) {
		return getPersistence().getBars(pk, start, end);
	}
	...
	*/
	public static List<com.liferay.curso.model.Bar> getBars(long pk, int start,
		...
		return getPersistence().getBars(pk, start, end, orderByComparator);
	}
	...
	*/
	public static int getBarsSize(long pk) {
		return getPersistence().getBarsSize(pk);
	}
	...
	*/
	public static boolean containsBar(long pk, long barPK) {
		return getPersistence().containsBar(pk, barPK);
	}
	...
	*/
	public static boolean containsBars(long pk) {
		return getPersistence().containsBars(pk);
	}
	...
	* @param barPK the primary key of the bar
	*/
	public static void addBar(long pk, long barPK) {
		getPersistence().addBar(pk, barPK);
	}
	...
	* @param bar the bar
	*/
	public static void addBar(long pk, com.liferay.curso.model.Bar bar) {
		getPersistence().addBar(pk, bar);
	}
	...
	*/
	public static void addBars(long pk, long[] barPKs) {
		getPersistence().addBars(pk, barPKs);
	}
	...
	* @param bars the bars
	*/
	public static void addBars(long pk, List<com.liferay.curso.model.Bar> bars) {
		getPersistence().addBars(pk, bars);
	}
	...
	*/
	public static void clearBars(long pk) {
		getPersistence().clearBars(pk);
	}
	...
	* @param barPK the primary key of the bar
	*/
	public static void removeBar(long pk, long barPK) {
		getPersistence().removeBar(pk, barPK);
	}
	...
	* @param bar the bar
	*/
	public static void removeBar(long pk, com.liferay.curso.model.Bar bar) {
		getPersistence().removeBar(pk, bar);
	}
	...
	* @param barPKs the primary keys of the bars
	*/
	public static void removeBars(long pk, long[] barPKs) {
		getPersistence().removeBars(pk, barPKs);
	}
	...
	* @param bars the bars
	*/
	public static void removeBars(long pk,
		List<com.liferay.curso.model.Bar> bars) {
		getPersistence().removeBars(pk, bars);
	}
	...
	*/
	public static void setBars(long pk, long[] barPKs) {
		getPersistence().setBars(pk, barPKs);
	}
	...
	*/
	public static void setBars(long pk, List<com.liferay.curso.model.Bar> bars) {
		getPersistence().setBars(pk, bars);
	}
